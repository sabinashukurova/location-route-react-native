  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.searchContainer}>
        <InputAutocomplete placeholder='Your location' onPlaceSelected={(details) => {onPlaceSelected(details, "origin")}} />
        <InputAutocomplete placeholder='Destination' onPlaceSelected={(details) => {onPlaceSelected(details, "destination")}} />
        <TouchableOpacity style={styles.button} onPress={route}><Text style={styles.buttonText}>Your route</Text></TouchableOpacity>
        {distance && duration ? (
        <View>
